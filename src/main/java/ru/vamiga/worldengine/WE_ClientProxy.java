...
/**
 * Класс ClientProxy. Используется при инициализации и загрузке.
 * (!) Эти действия будут выполнены ТОЛЬКО на стороне КЛИЕНТА.
 * @author VamigA
 */
public class WE_ClientProxy extends WE_CommonProxy {
	/**
	 * Функция прединициализации (только для клиента).
	...
	/**
	 * Функция инициализации (только для клиента).
	...
	/**
	 * Функция постинициализации (только для клиента).
